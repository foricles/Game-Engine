...
namespace kmu
{
	...
	public:
		...
		virtual inline float magnitude();
		virtual inline float sqrMagnitude();
		virtual inline float angle();
		virtual inline float dot(const vec2 &vec);
		virtual inline float cross(const vec2 &vec);
		virtual inline vec2 &normalize();
		virtual inline vec2 normalized();
	...
	public:
		...
		virtual inline float magnitude();
		virtual inline float sqrMagnitude();
		virtual inline float dot(const vec3 &vec);
		virtual inline vec3 cross(const vec3 &vec);
		virtual inline vec3 &normalize();
		virtual inline vec3 normalized();
		virtual inline std::string toString();
	...
	public:
		...
		virtual inline float dot(const vec4 &vec);
		virtual inline float magnitude();
		virtual inline vec4 &normalize();
		virtual inline vec4 normalized();
		virtual inline std::string toString();
